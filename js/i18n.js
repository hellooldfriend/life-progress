...
const I18N = (() => {
  ...
  const en = {
    ...
    'label.inbox': 'Inbox',
    'label.life': 'Life', 'sub.life': 'goals for years ahead — no deadline',
    ...
    'add.life': 'a goal for years ahead',
    ...
    'summary.quarter': 'Quarter review', 'summary.year': 'Year review', 'summary.life': 'Life notes',
    ...
    'target.quarter': 'quarter', 'target.year': 'year', 'target.life': 'life',
    'filters.all': 'all',
  ...
  const ru = {
    ...
    'label.life': 'Жизнь', 'sub.life': 'цели на годы вперёд — без срока',
    ...
    'summary.quarter': 'Итоги квартала', 'summary.year': 'Итоги года', 'summary.life': 'Заметки',
    ...
    'target.quarter': 'квартал', 'target.year': 'год', 'target.life': 'жизнь',
    'filters.all': 'все',
